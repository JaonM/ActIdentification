...
public class RunFragment extends MyFragment {
					...
					if(Util.tableIsExist(db, tester.getText().toString()+"_"+TYPE)) {
						...
						.setPositiveButton("是", new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,int which) {
								...
								sm.registerListener(RunFragment.this,sm.getDefaultSensor(Sensor.TYPE_ACCELEROMETER),SensorManager.SENSOR_DELAY_GAME);
					...
					if(tester.getText().toString().equals(""))
						...
						.setPositiveButton("是", new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,int which) {
								...
								sm.unregisterListener(RunFragment.this);
								if(mTimer!=null)
									mTimer.cancel();
								if(timer!=null)
									timer.cancel();
